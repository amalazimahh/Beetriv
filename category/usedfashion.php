...
$result = "SELECT * FROM product WHERE prd_category= 'Fashion' && prd_condition= 'Used'";
...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light" style='color:black' > 
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form action = "usedfashion.php" method = "post">
        ...
        <div class="prd-div"><h3>Fashion - Used</h3></div>
                        ...
                        <div class="category-bar">
                            <div class="left-sidebar">
                                ...
                                <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4 class="panel-title"><a href="mobile.php">Mobiles and Electronics</a></h4>
                                        </div>
                                    </div>
