...
$result = "SELECT * FROM product WHERE prd_category= 'Cars'";
...
<html lang="en">
    ...
    <body>
        ...
        <div class="prd-div"><h3>Cars and Property</h3></div>
                            ...
                            <div class="left-sidebar">
                                ...
                                <div class="price-range">
                                    ...
                                    <div class="well text-center">
                                        ...
                                        $result = "SELECT * FROM product WHERE prd_price BETWEEN '$min' AND '$max' AND prd_category= 'Cars'";
                                        $handle = $conn->prepare($result);
                                        $handle->execute();
                                        $row = $handle->fetchAll(PDO::FETCH_ASSOC);
                                        } ?>
