...
$result = "SELECT * FROM product WHERE prd_category= 'Hobbies' && prd_condition= 'New'";
...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light" style='color:black' > 
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form action = "newhobbies.php" method = "post">
        ...
        <div class="prd-div"><h3>Hobbies and Games - New</h3></div>
                            ...
                            <div class="left-sidebar">
                                ...
                                <div class="price-range">
                                    ...
                                    <div class="well text-center">
                                        ...
                                        $result = "SELECT * FROM product WHERE prd_price BETWEEN '$min' AND '$max' AND prd_category= 'Hobbies' && prd_condition= 'New'";
                                        $handle = $conn->prepare($result);
                                        $handle->execute();
                                        $row = $handle->fetchAll(PDO::FETCH_ASSOC);
                                        } ?>
