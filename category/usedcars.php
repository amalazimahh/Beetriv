...
$result = "SELECT * FROM product WHERE prd_category= 'Cars' && prd_condition= 'Used'";
...
<html lang="en">
    <head>
        ...
        * {box-sizing: border-box;}
        ...
        <title>Beetriv | Cars and Property</title>
        <!-- Favicon-->
    ...
    <body>
        ...
        <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light" style='color:black' > 
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form action = "usedcars.php" method = "post">
        ...
        <div class="prd-div"><h3>Cars and Property - Used</h3></div>
                            ...
                            <div class="left-sidebar">
                                ...
                                <div class="Item_condition">
                                    ...
                                    <div class="brands-name">
                                        <ul class="nav nav-pills nav-stacked">
                                            <li><a href="newcars.php"> <span class="pull-right"></span>New</a></li>
                                            <li><a href="usedcars.php"> <span class="pull-right"></span>Used</a></li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="price-range">
                                    ...
                                    <div class="well text-center">
                                        ...
                                        $result = "SELECT * FROM product WHERE prd_price BETWEEN '$min' AND '$max' AND prd_category= 'Cars' && prd_condition= 'Used'";
                                        $handle = $conn->prepare($result);
                                        $handle->execute();
                                        $row = $handle->fetchAll(PDO::FETCH_ASSOC);
                                        } ?>
